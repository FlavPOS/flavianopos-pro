...
class AdjustmentRejectedDetailScreen extends StatefulWidget {
  final String adjustmentId;
  final String branch;
  final String userName;

  const AdjustmentRejectedDetailScreen({
    super.key,
  ...
  @override
  State<AdjustmentRejectedDetailScreen> createState() =>
      _AdjustmentRejectedDetailScreenState();
}

class _AdjustmentRejectedDetailScreenState
    extends State<AdjustmentRejectedDetailScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (_doc != null) ...[
                  ...
                  Text('Rejected by: ${_doc!.rejectedBy}',
                      style: const TextStyle(
                          color: _textSecondary, fontSize: 11)),
                  if (_doc!.rejectionReason.isNotEmpty) ...[
                    ...
                    Container(
                      ...
                      child: Text('Reason: ${_doc!.rejectionReason}',
                          style: const TextStyle(
                              color: _red,
                              fontSize: 11,
