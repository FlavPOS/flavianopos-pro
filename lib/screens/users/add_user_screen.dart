    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: const EdgeInsets.all(16),
        child: Form(key: _formKey, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          DropdownButtonFormField<String>(initialValue: AppUser.availableRoles.contains(_selectedRole) ? _selectedRole : 'Custom',
          ...
          const SizedBox(height: 12),
          DropdownButtonFormField<String>(initialValue: _selectedBranch,
